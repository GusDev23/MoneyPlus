<%@ Page Title="" Language="C#" MasterPageFile="~/Usuario/UserMaster.Master" AutoEventWireup="true" CodeBehind="DashBoardIngresos.aspx.cs" Inherits="WebAppMoneyPlus.Usuario.DashBoardIngresos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="Main_Container">
        ...
        <div class="Panel">
            <div class="SectionTitle mb-3 fs-2 text-center">Ingresos</div>
                <div class="row mb-3">
                    
                    <asp:Repeater ID="RepIngresos" runat="server">
                        <ItemTemplate>
                            <div class="col-md-4 col-sm-6 mt-4">                                 
                                    <div class="card text-center">
                                        <div class="card-header fw-bold text-light" style="background-color:#094976" >
            ...
            <div class="text-center mb-3"><asp:Label ID="lblTotalIngreso" CssClass="SectionSubTitle mt-3 fs-4" runat="server" Text="Label"></asp:Label></div>
